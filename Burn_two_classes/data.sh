...
#SBATCH --mem=16000
#SBATCH --gres=gpu:geforce:1    ## GPU type and number, alternates: gpu:geforce:2,  gpu:tesla:1, gpu:tesla:2
...
# paths
RUNDIR=/storage02/43299_sp0039/burn_model

INDIR=/storage02/43299_sp0039/burn-test-inputs
